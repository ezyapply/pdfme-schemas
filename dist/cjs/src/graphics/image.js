...
const imageSchema = {
    pdf: async (arg) => {
        ...
        const lProps = (0, utils_js_1.convertForPdfLayoutProps)({ schema: _schema, pageHeight });
    ...
    ui: async (arg) => {
        ...
        if ((!value || isDefault) && editable) {
            ...
            const labelStyle = {
                ...
                position: 'absolute',
                top: 0,
                backgroundColor: editable || value ? (0, utils_js_1.addAlphaToHex)(theme.colorPrimaryBg, 30) : 'none',
                cursor: 'pointer',
            };
